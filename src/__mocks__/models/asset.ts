...
export const assetData: UserMarket[] = [
  {
    id: 'sxp',
    symbol: 'SXP',
    decimals: 18,
    ...
    supplyXvsApr: new BigNumber('0.01720675342484096'),
    supplyXvsApy: new BigNumber('0.11720675342484096'),
    borrowXvsApr: new BigNumber('4.07469243006608279'),
    borrowXvsApy: new BigNumber('4.17469243006608279'),
    ...
    collateral: true,
    percentOfLimit: '0',
    totalBorrowsCents: new BigNumber('70925716.2839193373613181'),
    totalSupplyCents: new BigNumber('278311516.880071415163614'),
  ...
  },
  {
    ...
    supplyXvsApr: new BigNumber('1.153105649796123742'),
    supplyXvsApy: new BigNumber('1.353105649796123742'),
    borrowXvsApr: new BigNumber('1.370327607690572731'),
    borrowXvsApy: new BigNumber('1.670327607690572731'),
    ...
    collateral: false,
    percentOfLimit: '0',
    totalBorrowsCents: new BigNumber('858721657509436.623174884152'),
    totalSupplyCents: new BigNumber('1000183891879506332139.9292470565707358'),
  ...
  },
  {
    ...
    supplyXvsApr: new BigNumber('0.221719501189155143'),
    supplyXvsApy: new BigNumber('0.421719501189155143'),
    borrowXvsApr: new BigNumber('0.322209972682294832'),
    borrowXvsApy: new BigNumber('0.522209972682294832'),
    collateralFactor: new BigNumber('0.8'),
    ...
    collateral: false,
    percentOfLimit: '0',
    totalBorrowsCents: new BigNumber('3158444721.332384892254'),
    totalSupplyCents: new BigNumber('100980412010115687912488517.7789655772798633'),
  ...
  },
  {
    ...
    supplyXvsApr: new BigNumber('0.578420831753642169'),
    supplyXvsApy: new BigNumber('0.678420831753642169'),
    borrowXvsApr: new BigNumber('0.552697602175970714'),
    borrowXvsApy: new BigNumber('0.852697602175970714'),
    collateralFactor: new BigNumber('0.8'),
    ...
    collateral: false,
    percentOfLimit: '0',
    totalBorrowsCents: new BigNumber('83910350502.1928887132528691'),
    totalSupplyCents: new BigNumber('1054707853878.3839597655397544'),
